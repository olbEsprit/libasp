...
namespace WebUserControl
{
    ...
    /// </summary>
    public class TreeRepesentation
    {
        ...
        /// </summary>
        protected TreeViewExt tv_Full = null; //Теж розширений клас, не заради кліка, а заради пошуку по Id
        
        public TreeViewExt GetFullTree()
        {
        ...
        {
            private TreeRepesentation ctb_advanced;
            public FilterBoxOpenPropertys(TreeRepesentation ctb_advanced)
            {
        ...
        {
            private TreeRepesentation ctb_advanced;
            public TreeViewOpenPropertys(TreeRepesentation ctb_advanced)
            {
                this.ctb_advanced = ctb_advanced;
        ...
        public TreeRepesentation(Boolean isCheckBoxes) : this(isCheckBoxes, 20, SelectedItemView.NodeName) { }
        /// <summary>
        /// Конструктор розширеного КомбоТріБокса.
        /// По замовченню: спосіб відображення вибраного елементу - назва ноди
        /// </summary>
        ...
        public TreeRepesentation(Boolean isCheckBoxes, Int32 ShowFilterAfterNodeCount) : this(isCheckBoxes, ShowFilterAfterNodeCount, SelectedItemView.NodeName) { }
        /// <summary>
        /// Конструктор розширеного КомбоТріБокса.
        /// По замовченню: Фільтр покажеться, якщо нодів буде більше ніж 20
        /// </summary>
        ...
        public TreeRepesentation(Boolean isCheckBoxes, SelectedItemView selectedItemView) : this(isCheckBoxes, 20, selectedItemView) { }
        /// <summary>
        /// Конструктор розширеного КомбоТріБокса.
        /// </summary>
        /// <param name="isCheckBoxes">Мультивибір</param>
        /// <param name="ShowFilterAfterNodeCount">Показувати фільтр, якщо нодів більше ніж N, Якщо 0 - завжди показувати, якщо -1 - ніколи не показувати</param>
        /// <param name="selectedItemView">Cпосіб відображення вибраного елементу</param>
        public TreeRepesentation(Boolean isCheckBoxes, Int32 ShowFilterAfterNodeCount, SelectedItemView selectedItemView)
        {
        ...
        public void SelectedItemsClear()
        {
            ...
            {
                TreeNode tn = null;/// TreeManager.FindNode(tv_Visible.Nodes, lastSelectedNode.Text, true);
                if (tn != null)
                {
    ...
    public delegate void SelectedItemChangedDelegate(TreeRepesentation sender);
